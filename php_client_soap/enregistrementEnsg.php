...
if(isset($_POST['valider'])) {
  ...
  curl_setopt_array($curl, array(
    ...
    CURLOPT_POSTFIELDS =>
    "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:met=\"http://enseignant.metiers/\">
      <soapenv:Header/>
        <soapenv:Body>
          <met:enregistrement>
              <!--Optional:-->
...
<body>
    <div class="container">
             ...
             <form name="enregistrement" method="post" action="" class="needs-validation" novalidate>
