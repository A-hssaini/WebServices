...
<div class="container">
             ...
             <form name="modification" method="post" action="ModificationServletMod" class="needs-validation" novalidate>
                 
                     <div class="form-row">
                         <label for="code"><b>Code</b></label>
                         <input type="number" name="id" class="form-control" id="code" placeholder="code" required>
